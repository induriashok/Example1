...
public class ProfilePaymentActvity extends BaseAbstractActivity<ProfileActImpl> implements ProfileActContract.IView, View.OnClickListener, APIResponseCallback {
    ...
    private String base64profile = "", base64aadhar = "";
    private ContentValues contentValue;
    Uri imageUri;

    private String owner_id, room_type, package_type, from_date, to_date, share_type,owner_pic;
    ...
    protected void initializeViews() {
        ...
        userSession = new UserSession(ProfilePaymentActvity.this);
        user_id = userSession.getUserDetails().get("id");
        token = userSession.getUserDetails().get("token");

       /* Calendar calendar = Calendar.getInstance();
        final int curent_year = calendar.get(Calendar.YEAR);
        System.out.println("curent_year"+curent_year);
*/
        userSession = new UserSession(ProfilePaymentActvity.this);
        user_id = userSession.getUserDetails().get("id");
        token = userSession.getUserDetails().get("token");
        ...
        tv_dob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(ProfilePaymentActvity.this,
        ...
        linear_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                System.out.println("yearhdfj" + selectedyear);
                ...
                if (et_name.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(context, "Enter aadhaar number", Toast.LENGTH_SHORT).show();
                } else if (base64profile.isEmpty() && userProfilePojo.getResponse().getProfile_pic() == null) {
                    Toast.makeText(context, "Upload Profile Image", Toast.LENGTH_SHORT).show();
                } else if (base64aadhar.isEmpty() && userProfilePojo.getResponse().getAadhar_card() == null) {
                    Toast.makeText(context, "Upload aadhaar card ", Toast.LENGTH_SHORT).show();
        ...
        try {
            ...
            if (jsonObject.optString("status_code").equals("5000")) {
                ...
                if (jsonObject.optBoolean("status") == true) {
                    ...
                    System.out.println("emailidgggggg"+userProfilePojo.getResponse().getAadhar_card_number());
                ...
                if (jsonObject.optBoolean("status") == true) {
                    ...
                    Intent intent1 = new Intent(ProfilePaymentActvity.this, ContinueBookingActivity.class);
