...
public interface ProfileActContract {
    ...
    interface IPresenter {
        ...
        void profile(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);

        void updateProfile(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
