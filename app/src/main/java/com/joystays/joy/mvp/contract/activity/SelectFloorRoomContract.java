...
public interface SelectFloorRoomContract {
    ...
    interface IPresenter {
        ...
        void getFloors(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);

        void getBeds(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);

        void getRooms(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);

        void hostel_floors(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void userLogin(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void check_hostel_prices(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
