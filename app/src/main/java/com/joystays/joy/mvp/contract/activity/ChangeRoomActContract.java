...
public interface ChangeRoomActContract {
    ...
    interface IPresenter {
        ...
        void changRoom(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void hostel_floors(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void hostel_beds(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void hostel_rooms(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
