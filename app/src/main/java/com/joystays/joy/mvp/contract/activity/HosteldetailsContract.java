...
public interface HosteldetailsContract {
    ...
    interface IPresenter {
        ...
        void hostelDetails(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);

        void hostelPrices(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
