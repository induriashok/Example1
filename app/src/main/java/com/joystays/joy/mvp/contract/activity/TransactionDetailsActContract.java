...
public interface TransactionDetailsActContract {
    ...
    interface IPresenter {
        ...
        void transactionsDetails(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
