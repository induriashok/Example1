...
public interface OTPVerificationContract {
    ...
    interface IPresenter {
        ...
        void verifiyOTP(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);

        void forgot_pass(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);

        // void resendOTP(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
