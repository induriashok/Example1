...
public interface BookingStatusAcContract {
    ...
    interface IPresenter {
        ...
        void bookingStatus(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        ...
        void complaint(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
