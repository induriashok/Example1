...
public interface FoodPollContract {
    ...
    interface IPresenter {
        ...
        void send_polls(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void getPoll(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
